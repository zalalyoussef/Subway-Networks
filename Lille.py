...
nodes = [str(j) for j in range(107)]  # the sist of all stops

Data_File_Path = './Lille-Data.txt'
...
with open('./Lille-Data.txt', encoding='utf8') as reader:
    for j in range(107):
...
with open('./Lille-Data.txt','r') as reader:
        for j in range(107):
           data = reader.readline()
        for j in range(116):
                data = reader.readline()
